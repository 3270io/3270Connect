---
seo_title: "CompatibilityProfile schema as 3270Connect writes it"
description: >-
  The CompatibilityProfile document 3270Connect writes in -profile mode,
  field by field, so it can be diffed against one 3270Web captured in a
  browser.
---
